...
export default function Home() {
  return (
    <div >
      <Head>
        <title>Code Swear</title>
        <meta name="description" content="codewear.com" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div>
        <img src="man-woman-celebrating-their-wedding-beach.png" alt="" className='min-w-full max-h-72' />
      </div>

      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Weare the code with codeswear.com</h1>
